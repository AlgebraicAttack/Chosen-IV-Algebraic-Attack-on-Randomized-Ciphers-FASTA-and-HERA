...
# This file was *autogenerated* from the file fasta-attack.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_329 = Integer(329); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_18 = Integer(18); _sage_const_61 = Integer(61); _sage_const_11 = Integer(11); _sage_const_0 = Integer(0); _sage_const_100 = Integer(100)
...
class FASTA:
    def __init__(self, b, s, rounds):
        ...
        self.var_u = [
            self.var_u[i * self.n_keys : (i + _sage_const_1 ) * self.n_keys] for i in range(self.b)
        ]

        self.rounds = rounds

        self.constants = [
            [GF(_sage_const_2 ).random_element() for _ in range(self.n_u)] for _ in range(rounds + _sage_const_1 )
        ]
        self.matrixs = []

        self.r1_list = []
        self.r2_list = []
        self.r3_base = _sage_const_5 
        self.r3_mod = _sage_const_3 
        self.i_base = [_sage_const_1 , _sage_const_3 ]
        self.j_base = [_sage_const_2 , _sage_const_4 ]
        self.l_base = [_sage_const_3 , _sage_const_5 ]

        if b == _sage_const_5  and s == _sage_const_329 :
            self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 , _sage_const_3 ]) for _ in range(_sage_const_4 )]
            self.r2_list = [random.choice([_sage_const_4 , _sage_const_5 , _sage_const_6 ]) for _ in range(_sage_const_4 )]
            self.r3_base = _sage_const_7 
            self.i_random = _sage_const_4 
            self.j_random = _sage_const_18 
            self.l_random = _sage_const_61 
        elif b == _sage_const_3  and s == _sage_const_5 :
            self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 ]) for _ in range(_sage_const_4 )]
            self.r2_list = [random.choice([_sage_const_3 , _sage_const_4 ]) for _ in range(_sage_const_4 )]
            self.r3_base = _sage_const_5 
            self.r3_mod = _sage_const_3 
            self.i_base = [_sage_const_1 , _sage_const_3 ]
            self.j_base = [_sage_const_2 , _sage_const_4 ]
            self.l_base = [_sage_const_3 , _sage_const_5 ]
            self.t = _sage_const_3 
        elif b == _sage_const_3  and s == _sage_const_11 :
            self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 ]) for _ in range(_sage_const_4 )]
            self.r2_list = [random.choice([_sage_const_3 , _sage_const_4 ]) for _ in range(_sage_const_4 )]
            self.r3_base = _sage_const_5 
            self.r3_mod = _sage_const_3 
            ...
            self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 ]) for _ in range(_sage_const_4 )]
            self.r2_list = [random.choice([_sage_const_3 , _sage_const_4 ]) for _ in range(_sage_const_4 )]
            self.r3_base = _sage_const_0 
            self.r3_mod = _sage_const_0 
            self.i_base = [_sage_const_1 , _sage_const_2 ]
            self.j_base = [_sage_const_2 , _sage_const_3 ]
            self.l_base = [_sage_const_3 , _sage_const_4 ]
            self.t = _sage_const_3 
        elif b == _sage_const_3  and s == _sage_const_7 :
            self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 ]) for _ in range(_sage_const_4 )]
            self.r2_list = [random.choice([_sage_const_3 , _sage_const_4 ]) for _ in range(_sage_const_4 )]
            self.r3_base = _sage_const_5 
            self.r3_mod = _sage_const_3 
            ...
            self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 , _sage_const_3 ]) for _ in range(_sage_const_4 )]
            self.r2_list = [random.choice([_sage_const_2 , _sage_const_3 , _sage_const_4 ]) for _ in range(_sage_const_4 )]
            self.r3_base = _sage_const_2 

    def chi_operation(self, state):
        output_state = [[_sage_const_0  for _ in range(self.n_keys)] for _ in range(self.b)]
        for i in range(self.b):
            for j in range(self.n_keys):
                output_state[i][j] = (
                    state[i][j]
                    + (state[i][(j + _sage_const_1 ) % self.n_keys] + _sage_const_1 )
                    * state[i][(j + _sage_const_2 ) % self.n_keys]
                )
        return output_state

    def linear_transformation(self, state, r):
        new_state = [_sage_const_0 ] * self.n_u
        if r == _sage_const_0 :
            if self.b == _sage_const_3 :
                i = [_sage_const_1 , _sage_const_0 ]
                j = [_sage_const_0 , _sage_const_1 ]
                l = [_sage_const_1 , _sage_const_1 ]
            elif self.b == _sage_const_5 :
                i = [_sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 ]
                j = [_sage_const_0 , _sage_const_1 , _sage_const_2 , _sage_const_1 ]
                l = [_sage_const_1 , _sage_const_2 , _sage_const_0 , _sage_const_1 ]
            elif self.b == _sage_const_7 :
                i = [_sage_const_1 , _sage_const_1 ]
                j = [_sage_const_0 , _sage_const_1 ]
                l = [_sage_const_1 , _sage_const_0 ]
            if self.n_keys == _sage_const_5 :
                r1_list = [_sage_const_1 , _sage_const_2 , _sage_const_2 , _sage_const_1 ]
                r2_list = [_sage_const_3 , _sage_const_4 , _sage_const_3 , _sage_const_4 ]
            elif self.n_keys == _sage_const_7 :
                r1_list = [_sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_2 ]
                r2_list = [_sage_const_3 , _sage_const_3 , _sage_const_4 , _sage_const_3 ]
            ...
            M = Matrix(GF(_sage_const_2 ), self.n_u, self.n_u, _sage_const_0 )
            while not M.is_invertible():
                i = [random.randint(_sage_const_0 , _sage_const_1 ) for _ in range(self.b - _sage_const_1 )]
                j = [random.randint(_sage_const_0 , _sage_const_1 ) for _ in range(self.b - _sage_const_1 )]
                l = [random.randint(_sage_const_0 , _sage_const_1 ) for _ in range(self.b - _sage_const_1 )]
                self.r1_list = [random.choice([_sage_const_1 , _sage_const_2 ]) for _ in range(_sage_const_4 )]
                self.r2_list = [random.choice([_sage_const_3 , _sage_const_4 ]) for _ in range(_sage_const_4 )]
                M = build_fasta_linear_layer(
                    self.b,
        ...
        if r == _sage_const_0 :
            ...
            new_state = list(new_state + vector(GF(_sage_const_2 ), self.constants[r]))

        new_state_1 = [
            new_state[i * self.n_keys : (i + _sage_const_1 ) * self.n_keys] for i in range(self.b)
        ]
        return new_state_1

    def forward_compute(self):
        self.init_state = [self.var_k]
        for i in range(_sage_const_1 , self.b):
            self.init_state.append(self.var_k[i:] + self.var_k[:i])

        forward_state = self.linear_transformation(self.init_state, _sage_const_0 )

        first_linear_state = [[_sage_const_0  for _ in range(self.n_keys)] for _ in range(self.b)]
        ...
        u_state = [[_sage_const_0  for _ in range(self.n_keys)] for _ in range(self.b)]
        for i in range(self.b):
            for j in range(self.n_keys):
                u_state[i][j] = (
                    first_linear_state[i][(j + _sage_const_1 ) % self.n_keys]
                    * first_linear_state[i][(j + _sage_const_2 ) % self.n_keys]
                )

        rc_0 = [
            self.constants[_sage_const_0 ][i * self.n_keys : (i + _sage_const_1 ) * self.n_keys]
            for i in range(self.b)
        ]
        # for i in range(self.b):
        #     for j in range(self.n_keys):
        ...
        for i in range(self.b):
            for j in range(self.n_keys):
                forward_state[i][j] = (
                    ...
                    + rc_0[i][j]
                    + self.var_u[i][j]
                    + forward_state[i][(j + _sage_const_1 ) % self.n_keys]
                    * rc_0[i][(j + _sage_const_2 ) % self.n_keys]
                    + forward_state[i][(j + _sage_const_2 ) % self.n_keys]
                    + rc_0[i][(j + _sage_const_2 ) % self.n_keys]
                    + rc_0[i][(j + _sage_const_1 ) % self.n_keys]
                    * forward_state[i][(j + _sage_const_2 ) % self.n_keys]
                    + +rc_0[i][(j + _sage_const_1 ) % self.n_keys] * rc_0[i][(j + _sage_const_2 ) % self.n_keys]
                )

        for r in range(_sage_const_1 , self.rounds - _sage_const_1 ):
            forward_state = self.linear_transformation(forward_state, r)
            forward_state = self.chi_operation(forward_state)
        forward_state = self.linear_transformation(forward_state, self.rounds - _sage_const_1 )
        # print("first_linear_state:", first_linear_state)
    ...
    def backward_compute(self, key_value):
        ...
        M_last = Matrix(GF(_sage_const_2 ), self.n_u, self.n_u, _sage_const_0 )
        ...
        for r in range(self.rounds + _sage_const_1 ):
            # print(state_value, type(state_value))
            state_value = list(
                self.matrixs[r] * vector(GF(_sage_const_2 ), state_value)
                + vector(GF(_sage_const_2 ), self.constants[r])
            )
            # print("self.constants[r]):", self.constants[r])
            # print("after linear state value:", state_value, type(state_value))
            state_value = [
                state_value[i * self.n_keys : (i + _sage_const_1 ) * self.n_keys] for i in range(b)
            ]
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    state_value[i][j] = (
                        state_value[i][j]
                        + (state_value[i][(j + _sage_const_1 ) % self.n_keys] + _sage_const_1 )
                        * state_value[i][(j + _sage_const_2 ) % self.n_keys]
                    )
            # print("r:", r)
        ...
        backward_state = [
            backward_state[i * self.n_keys : (i + _sage_const_1 ) * self.n_keys]
            for i in range(self.b)
        ]
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    if (
                        ...
                        return equations
                    tmp_eq = backward_state[i][(j + _sage_const_1 ) % self.n_keys] * (
                        backward_state[i][j] + forward_state[i][j]
                    )
                    equations.append(tmp_eq)
                    # print(num_equations)
                    # print(tmp_eq)
                    num_equations += _sage_const_1 
                    num_equations_from_last += _sage_const_1 
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    ...
                    tmp_eq = (
                        backward_state[i][j]
                        + forward_state[i][j]
                        + backward_state[i][(j + _sage_const_1 ) % self.n_keys]
                        * (forward_state[i][(j + _sage_const_2 ) % self.n_keys] + _sage_const_1 )
                    )
                    equations.append(tmp_eq)
                    # print(num_equations)
                    # print(tmp_eq)
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    if (
                        ...
                        return equations
                    tmp_eq = backward_state[i][(j + _sage_const_3 ) % self.n_keys] * (
                        backward_state[i][(j + _sage_const_2 ) % self.n_keys]
                        * backward_state[i][(j + _sage_const_1 ) % self.n_keys]
                        + backward_state[i][(j + _sage_const_2 ) % self.n_keys]
                        + backward_state[i][j]
                        + forward_state[i][j]
                ...
                for i in range(self.b):
                    for j in range(self.n_keys):
                        if num_equations >= all_num_monomials:
                            return equations
                        equations.append(
                            backward_state[i][(j + _sage_const_5 ) % self.n_keys]
                            * (
                                forward_state[i][j]
                                + forward_state[i][(i + _sage_const_2 ) % self.n_keys]
                                + backward_state[i][j]
                                + backward_state[i][(j + _sage_const_1 ) % self.n_keys]
                                * backward_state[i][(j + _sage_const_2 ) % self.n_keys]
                                + backward_state[i][(j + _sage_const_1 ) % self.n_keys]
                                * (backward_state[i][(j + _sage_const_3 ) % self.n_keys] + _sage_const_1 )
                                * backward_state[i][(j + _sage_const_4 ) % self.n_keys]
                            )
                        )
                        num_equations += _sage_const_1 
            if self.n_keys > _sage_const_7 :
                for i in range(self.b):
                    for j in range(self.n_keys):
                        if num_equations >= all_num_monomials:
                            return equations
                        equations.add(
                            backward_state[i][(j + _sage_const_7 ) % self.n_keys]
                            * (
                                forward_state[i][j]
                                + backward_state[i][j]
                                + (backward_state[i][(j + _sage_const_1 ) % self.n_keys] + _sage_const_1 )
                                * backward_state[i][(j + _sage_const_2 ) % self.n_keys]
                                + (backward_state[i][(j + _sage_const_1 ) % self.n_keys] + _sage_const_1 )
                                * (backward_state[i][(j + _sage_const_3 ) % self.n_keys] + _sage_const_1 )
                                * (
                                    backward_state[i][(j + _sage_const_4 ) % self.n_keys]
                                    + (backward_state[i][(j + _sage_const_5 ) % self.n_keys] + _sage_const_1 )
                                    * backward_state[i][(j + _sage_const_6 ) % self.n_keys]
                                )
                            )
                        )
                        num_equations += _sage_const_1 
        ...
        if degree == _sage_const_2 :
            for i in range(self.b):
                for j in range(self.n_keys):
                    ...
                    num_equations += _sage_const_1 
                    num_equations_from_uf += _sage_const_1 
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    ...
                    if (
                        ...
                        return equations
                    tmp_eq = (
                        self.var_u[i][j] * first_linear_state[i][(j + _sage_const_1 ) % self.n_keys]
                        + u_state[i][j]
                    )
                    equations.append(tmp_eq)
                    # print(num_equations)
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    ...
                    if (
                        ...
                        return equations
                    tmp_eq = (
                        self.var_u[i][j] * first_linear_state[i][(j + _sage_const_2 ) % self.n_keys]
                        + u_state[i][j]
                    )
                    equations.append(tmp_eq)
                    # print(num_equations)
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    ...
                    tmp_eq = (
                        ...
                        + self.var_u[i][(j - _sage_const_1 ) % self.n_keys]
                        * first_linear_state[i][(j + _sage_const_2 ) % self.n_keys]
                    )
                    equations.append(tmp_eq)
                    # print(num_equations)
                ...
                for j in range(self.n_keys):
                    ...
                    for k in range(self.n_keys):
                        if (
                            ...
                            return equations
                        elif k != (j + _sage_const_1 ) % self.n_keys and k != (j + _sage_const_2 ) % self.n_keys:
                            # print("k:", k)
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    ...
                    if (
                        ...
                        return equations
                    tmp = (
                        self.var_u[i][j] * self.var_u[i][(j + _sage_const_1 ) % self.n_keys]
                        + first_linear_state[i][(j + _sage_const_1 ) % self.n_keys]
                        * first_linear_state[i][(j + _sage_const_2 ) % self.n_keys]
                        * first_linear_state[i][(j + _sage_const_3 ) % self.n_keys]
                    )
                    equations.append(tmp)
                    # tmp = self.var_u[i][j] + u_state[i][j]
                    # print(num_equations)
                ...
                for j in range(self.n_keys):
                    for k in range(self.n_keys):
                        if (
                            ...
                            return equations
                        if k != (j + _sage_const_1 ) % self.n_keys:
                            tmp = (
                                self.var_u[i][j]
                                * first_linear_state[i][k]
                                * first_linear_state[i][(j + _sage_const_1 ) % self.n_keys]
                ...
                for j in range(self.n_keys):
                    for k in range(self.n_keys):
                        if (
                            ...
                            return equations
                        if k != (j + _sage_const_1 ) % self.n_keys and k != (j + _sage_const_2 ) % self.n_keys:
                            tmp = (
                                self.var_u[i][j]
                                * first_linear_state[i][(j + _sage_const_2 ) % self.n_keys]
                                * first_linear_state[i][k]
    ...
    def generate_boolean_monomials(self, degree, first_linear_state):
        ...
        monomials = [self.R(_sage_const_1 )]
        for deg in range(_sage_const_1 , degree + _sage_const_1 ):
            for subset in combinations(vars, deg):
                # print(subset)
                monomial = prod(subset)
                if monomial != self.R(_sage_const_1 ):
            ...
            for i in range(self.b):
                for j in range(self.n_keys):
                    if monomial != self.R(_sage_const_1 ):
                        ...
                        if tmp_s.degree() == degree and tmp_s != self.R(_sage_const_0 ):
                            if num_equations >= all_num_monomials:
                                return equations
...
def gaussian_elimination_bool(matrix):
    ...
    for i in range(m):
        ...
        for j in range(len(basis)):
            p = pivot_cols[j]
            if row[p] == _sage_const_1 :

                for k in range(n):
                    row[k] = (row[k] + basis[j][k]) % _sage_const_2 

                v = v.symmetric_difference(v_basis[j])

        if all(x == _sage_const_0  for x in row):
            ...
            p = _sage_const_0 
            while p < n and row[p] == _sage_const_0 :
                p += _sage_const_1 
            if p < n:  # 找到主元列
                pivot_cols.append(p)
                basis.append(row)
...
def gf2elim(M):
    ...
    while i < m and j < n:
        ...
        col[i] = _sage_const_0   # avoid xoring pivot row with itself
...
for i in range(_sage_const_100 ):
    b = int(sys.argv[_sage_const_1 ])  # b parameter
    s = int(sys.argv[_sage_const_2 ])  # s parameter
    rounds = int(sys.argv[_sage_const_3 ])  # rounds parameter
    all_num_monomials = _sage_const_0 
    for i in range(_sage_const_2  ** (rounds - _sage_const_2 ) + _sage_const_2 ):
        all_num_monomials += binomial(b * s + s, i)
    all_num_monomials = all_num_monomials - binomial(b * s, _sage_const_2  ** (rounds - _sage_const_2 ) + _sage_const_1 ) - _sage_const_1 

    num_monomials_degree_1 = binomial(b * s + s, _sage_const_1 )
    num_monomials_degree_2 = (
        binomial(b * s + s, _sage_const_2 ) + binomial(b * s + s, _sage_const_1 ) - binomial(b * s, _sage_const_2 )
    )
    print("num_monomials_degree_2:", num_monomials_degree_2)
    num_monomials_degree_3 = (
        binomial(b * s + s, _sage_const_3 )
        + binomial(b * s + s, _sage_const_2 )
        + binomial(b * s + s, _sage_const_1 )
        - binomial(b * s, _sage_const_3 )
    )
    print("num_monomials_degree_3:", num_monomials_degree_3)
    num_monomials_degree_4 = (
        binomial(b * s + s, _sage_const_4 )
        + binomial(b * s + s, _sage_const_3 )
        + binomial(b * s + s, _sage_const_2 )
        + binomial(b * s + s, _sage_const_1 )
        - binomial(b * s, _sage_const_4 )
    )
    ...
    key_value = [GF(_sage_const_2 ).random_element() for _ in range(s)]
    ...
    if fasta.R(_sage_const_1 ) in monomial_set:
        monomial_set.remove(fasta.R(_sage_const_1 ))
    coefficient_matrix = zero_matrix(GF(_sage_const_2 ), len(equations), len(monomial_set))
    ...
    for i, eq in enumerate(equations):
        for monomial in eq.monomials():
            ...
            if monomial in monomial_set:
                ...
                coefficient_matrix[i, j] = _sage_const_1 
